...
### Encode a character vector as a `mega` string 
...
Encode the character vector to a factor on-the-fly, and re-create the character vector when reading.

* Calculate a dictionary of all unique strings in the character vector
* For each string in the original character vector, calculate its index within the dicionary
* Write out the dictionary and the list of indices
